...
public class LoginActionListener implements ActionListener {
	...
	public void processAction(ActionEvent event) throws AbortProcessingException {
		...
		String name 
			= (String)((UIInput)container.findComponent("form:name")).getValue();
		String password 
			= (String)((UIInput)container.findComponent("form:password")).getValue();
		
		if (Registrar.isRegistered(name, password)) {
			return;
		}
